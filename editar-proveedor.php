...
if(isset($_POST["actualizar"])){
	$datos = mysql_query("UPDATE store_providers SET fullname='".$_POST["fullname"]."', email='".$_POST["email"]."', address='".$_POST["address"]."', phone='".$_POST["phone"]."' WHERE pid='".$_GET["id"]."'");
	if($datos){
                ...
                <div id="page-right-content">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <h4 class="m-b-20 header-title">Editar proveedor</h4>

<?php
if(isset($_GET["id"])){
	$MostrarDatos = mysql_query("SELECT * FROM store_providers WHERE pid='".$_GET["id"]."' LIMIT 1");
