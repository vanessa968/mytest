...
if(isset($_POST["actualizar"])){
	$datos = mysql_query("UPDATE store_customers SET fullname='".$_POST["fullname"]."', email='".$_POST["email"]."', address='".$_POST["address"]."', phone='".$_POST["phone"]."' WHERE cid='".$_GET["id"]."'");
	if($datos){
...
<?php
if(isset($_GET["id"])){
	$MostrarDatos = mysql_query("SELECT * FROM store_customers WHERE cid='".$_GET["id"]."' LIMIT 1");
